...
final class StartupMotion {
  ...
  static void play(View view) {
    ...
    if (!ValueAnimator.areAnimatorsEnabled()
        || (accessibility != null && accessibility.isTouchExplorationEnabled())) return;
    view.post(
        () -> {
          ...
          if (host == null) return;
          View overlay =
              LayoutInflater.from(view.getContext()).inflate(R.layout.overlay_startup, host, false);
